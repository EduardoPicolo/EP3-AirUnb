...
class SpotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create spot" do
    assert_difference('Spot.count') do
      post spots_url, params: { spot: { address: @spot.address, description: @spot.description, price: @spot.price } }
    end
  ...
  test "should update spot" do
    patch spot_url(@spot), params: { spot: { address: @spot.address, description: @spot.description, price: @spot.price } }
